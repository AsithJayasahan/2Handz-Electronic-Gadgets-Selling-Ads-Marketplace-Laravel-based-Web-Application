                                ...
                                <div class="table-responsive users-container">
                                    <table class="table table-hover">
                                        ...
                                        <tbody class="scrollable-table-body">
                                            ...
                                            <tr>
                                              <td>{{ $message->name }}</td>
                                              <td><a href="tel:{{ $message->phoneNumber }}" style="text-decoration: none">{{ $message->phoneNumber }}</a></td>
                                              <td>{{ $message->subject }}</td>
                                              <td>{{ $message->message }}</td>
                                              <td>
                                                <a href="mailto:{{ $message->email }}" style="text-decoration: none">{{ $message->email }}</a>
                                              </td>
                                              <td>
                                                <button type="button" class="btn btn-inverse-danger btn-icon">
                                                  <a href="mailto:{{ $message->email }}"><i class="mdi mdi-email-open"></i></a>
                                                </button>
                                              </td>
                                            </tr>
                                            @endforeach
